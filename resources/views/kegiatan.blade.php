                    ...
                    <div class="col-md-6">
                        <div class="rounded"
                            ...
                            <div
                                ...
                                <a href="{{ route('pengumuman') }}" style="font-size: 0.9rem; text-decoration: none; color: #FBFADA;">Klik
                                    Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rounded"
                            ...
                            <div
                                ...
                                <h5 style="font-size: 1.2rem; font-weight: bold; margin: 0; color: #FBFADA;">Jadwal
                                    Kajian</h5>
                                <a href="{{ route('jadwalkajian') }}" style="font-size: 0.9rem; text-decoration: none; color: #FBFADA;">Klik
                                    Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="rounded"
                            ...
                            <div
                                ...
                                <h5 style="font-size: 1.2rem; font-weight: bold; margin: 0; color: #FBFADA;">Jadwal
                                    Jumat</h5>
                                <a href="{{ route('jadwaljumat') }}" style="font-size: 0.9rem; text-decoration: none; color: #FBFADA;">Klik
                                    Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="rounded"
                            ...
                            <div
                                ...
                                <a href="{{ route('agenda') }}" style="font-size: 0.9rem; text-decoration: none; color: #FBFADA;">Klik
                                    Selengkapnya</a>
                            </div>
                        </div>
                    </div>
