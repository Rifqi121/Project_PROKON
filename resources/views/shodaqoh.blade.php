                ...
                <div class="col-8 col-md-4">
                    <div class="card h-100"
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-shodaqoh" data-bs-toggle="modal"
                                data-bs-target="#shodaqohModal">Bayar Infaq</a>
                        </div>
                    </div>
                </div>
                <!-- Card 2 -->
                <div class="col-8 col-md-4">
                    <div class="card h-100"
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style="font-size: 0.9rem; margin-bottom: 1rem;">CP : 0813 2402 1587</p>
                            <a href="#" class="btn btn-shodaqoh" data-bs-toggle="modal"
                                data-bs-target="#zakatModal">Bayar Zakat</a>
                        </div>
                    </div>
                </div>
                <!-- Card 3 -->
                <div class="col-8 col-md-4">
                    <div class="card h-100"
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style="font-size: 0.9rem; margin-bottom: 1rem;">CP : 0813 2402 1587</p>
                            <a href="#" class="btn btn-shodaqoh" data-bs-toggle="modal"
                                data-bs-target="#shodaqohModal">Bayar Donasi</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion" id="paymentMethods">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingQRIS">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseQRIS" aria-expanded="false" aria-controls="collapseQRIS">
                                    QRIS
                                </button>
                            </h2>
                            <div id="collapseQRIS" class="accordion-collapse collapse" aria-labelledby="headingQRIS"
                                data-bs-parent="#paymentMethods">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseCash" class="accordion-collapse collapse" aria-labelledby="headingCash"
                                data-bs-parent="#paymentMethods">
                                <div class="accordion-body">
                                    Silakan langsung datang ke masjid Al-Ukhuwah dan menemui Bapak Fulan untuk pembayaran
                                    zakat tunai.
                                </div>
                            </div>
                        </div>
