    ...
    <table class="tabel-data table table-responsive table-striped table-borderless table-hover"
        ...
        <tbody>
            <tr>
                ...
                <td>Deskripsi Kajian</td>
                <td>1/1/2023</td>
                <td>
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                        data-bs-target="#detailKajianModal">Detail</button>
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                        data-bs-target="#editKajianModal">Edit</button>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="POST">
                ...
                <div class="modal-body">
                    <div>
                        <label for="judul_Kajian" class="form-label">Judul Kajian</label>
...
<div class="modal fade" id="detailKajianModal" tabindex="-1" aria-labelledby="detailKajianModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailKajianModalLabel">Kajian</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="#" method="GET">
                ...
                <div class="modal-body">
                    <div>
                        <label for="judul_Kajian" class="form-label">Judul Kajian</label>
                        <input type="text" class="form-control" id="judul_Kajian" name="judul_Kajian" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
...
<!-- Modal Edit Kajian -->
<div class="modal fade" id="editKajianModal" tabindex="-1" aria-labelledby="editKajianModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
