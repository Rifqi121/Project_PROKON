...
@section('content')
    <div class="card h-100" style="background-color: #2A332E;">
        <div class="p-4">
            <h2 style="font-size: 1.5rem; font-weight: bold; color: #FBFADA; margin-bottom: 1.5rem;">Laporan Infaq & Shodaqoh</h2>
            ...
            <div class="d-flex justify-content-start mt-3">
                <a href="{{ route('user.laporan') }}" class="btn btn-shodaqoh" 
                   style="background-color: #FBFADA; color: #2A332E; border-radius: 10px;">
                    Kembali
                </a>
            </div>
        </div>
