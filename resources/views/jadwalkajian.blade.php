...
<div class="card h-100" style="background-color: #2A332E;">
    <div class="p-4">
        <h2 style="font-size: 1.5rem; font-weight: bold; color: #FBFADA; margin-bottom: 1.5rem;">Jadwal Kajian</h2>
        <div style="background-color: #374139;">
            <div class="container py-2 d-flex justify-content-center align-items-center">
                ...
                <div class="input-group input-group-sm" style="width: 80%;">
                    ...
                    <input type="text" class="form-control" placeholder="Jadwal Kajian">
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailModalLabel">Judul Kajian</h5>
